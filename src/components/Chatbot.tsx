    ...
    <>
      ...
      {!open && (
        <div
          ...
          onClick={() => setOpen(true)}
        >
          <span style={{ fontWeight: 600 }}>Besoin d&apos;aide ?</span>
          <br />
        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ padding: 8, background: 'none', border: 'none', cursor: 'pointer', color: 'white', WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}
              aria-label="Fermer"
            >
