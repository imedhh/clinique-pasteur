          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden h-80">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3193.0!2d10.189!3d36.846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sClinique+Pasteur+Tunis!5e0!3m2!1sfr!2stn!4v1"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="flex gap-4">
                  <a href={clinicInfo.facebook} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center hover:bg-blue-200 transition text-blue-600 font-bold" aria-label="Facebook">
                    f
                  </a>
                  <a href={clinicInfo.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center hover:bg-pink-200 transition text-pink-600 font-bold" aria-label="Instagram">
                    in
                  </a>
                  <a href={clinicInfo.youtube} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center hover:bg-red-200 transition text-red-600 font-bold" aria-label="YouTube">
                    yt
                  </a>
                </div>
              </div>
