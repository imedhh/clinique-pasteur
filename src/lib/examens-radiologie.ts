...
A la Clinique Pasteur de Tunis, l'IRM est realisee sur un appareil de derniere generation offrant une qualite d'image optimale. L'equipe de radiologues specialises et de manipulateurs experimentes assure une prise en charge personnalisee, avec des protocoles adaptes a chaque indication clinique. Les resultats sont interpretes rapidement par des radiologues experts.`,
    ...
    indications: [
      { label: 'Pathologies cerebrales : tumeurs, AVC, sclerose en plaques, epilepsie', explication: `L'IRM est l'examen le plus precis pour observer le cerveau. Elle aide le medecin a comprendre l'origine de maux de tete inhabituels, de troubles de la memoire, de vertiges ou de crises, et a verifier l'etat des tissus cerebraux.` },
      { label: 'Pathologies rachidiennes : hernie discale, stenose canalaire, tumeurs', explication: `En cas de douleurs du dos ou du cou qui persistent, ou de douleurs qui descendent dans un bras ou une jambe, l'IRM montre les disques, les nerfs et la moelle epiniere pour identifier ce qui comprime ou irrite ces structures.` },
      { label: 'Pathologies articulaires : lesions meniscales, ligamentaires, cartilagineuses', explication: `Apres une entorse, un accident de sport ou des douleurs articulaires durables, l'IRM visualise avec finesse les menisques, ligaments et cartilages du genou, de l'epaule ou d'autres articulations, la ou la radiographie ne montre que les os.` },
      { label: 'Bilan d\'extension et suivi des cancers', explication: `Lorsqu'un cancer est diagnostique, l'IRM aide a preciser la taille de la lesion et a verifier si d'autres zones sont touchees. Elle sert aussi a suivre l'efficacite des traitements au fil du temps.` },
      { label: 'Pathologies hepatiques et biliaires', explication: `L'IRM permet d'etudier en detail le foie et les voies biliaires, par exemple pour caracteriser une anomalie decouverte a l'echographie ou rechercher un calcul dans les canaux biliaires, sans aucune radiation.` },
      { label: 'Pathologies pelviennes : uterus, ovaires, prostate, rectum', explication: `Pour les organes du bassin, l'IRM offre des images tres precises. Elle est demandee pour explorer des douleurs pelviennes, un fibrome, un kyste ou pour un bilan de la prostate ou du rectum.` },
      { label: 'Angiographie par resonance magnetique (ARM) des vaisseaux', explication: `Cette technique permet de visualiser les arteres et les veines sans intervention. Elle est utile pour verifier la bonne circulation du sang et rechercher un retrecissement ou une dilatation d'un vaisseau.` },
      { label: 'Pathologies cardiaques : IRM cardiaque de stress, viabilite myocardique', explication: `L'IRM cardiaque etudie le muscle du coeur en detail : elle evalue sa contraction, son irrigation et l'etat du tissu apres un probleme cardiaque, afin d'aider le cardiologue a choisir le traitement le plus adapte.` },
    ],
  },
  {
    slug: 'scanner',
...
A la Clinique Pasteur de Tunis, le scanner double energie est realise sur un appareil de derniere generation offrant une resolution spatiale et temporelle exceptionnelle. L'equipe de radiologues experts exploite pleinement les capacites de cette technologie pour fournir des diagnostics precis et rapides, dans un souci constant de radioprotection du patient.`,
    ...
    indications: [
      { label: 'Bilan et suivi des cancers : detection, extension, evaluation de la reponse therapeutique', explication: `Le scanner permet de reperer une lesion, de mesurer son etendue et de suivre son evolution pendant le traitement. C'est un outil essentiel pour que l'equipe medicale adapte la prise en charge a chaque etape.` },
      { label: 'Pathologies vasculaires : angioscanner, embolie pulmonaire, dissection aortique', explication: `Avec une injection de produit de contraste, le scanner visualise les vaisseaux sanguins en detail. Il est demande en urgence lorsqu'on suspecte un caillot dans les poumons ou une atteinte de l'aorte.` },
      { label: 'Pathologies thoraciques : nodules pulmonaires, pneumopathies, mediastin', explication: `En cas de toux persistante, d'essoufflement ou d'anomalie sur une radiographie, le scanner du thorax examine finement les poumons et la region situee entre eux pour en preciser la cause.` },
      { label: 'Pathologies abdominales et pelviennes : foie, pancreas, reins, colon', explication: `Le scanner explore l'ensemble des organes du ventre en quelques instants. Il aide a comprendre des douleurs abdominales, a caracteriser une anomalie vue a l'echographie ou a rechercher une infection.` },
      { label: 'Pathologies urologiques : calculs urinaires avec analyse de composition', explication: `Le scanner detecte les calculs des reins et des voies urinaires avec une grande fiabilite. La technologie double energie peut meme aider a determiner leur nature, ce qui oriente le traitement pour eviter les recidives.` },
      { label: 'Pathologies osteo-articulaires : fractures complexes, recherche de metastases osseuses', explication: `Quand une fracture est difficile a analyser sur une simple radiographie, le scanner fournit des images en trois dimensions des os. Il sert aussi a verifier l'etat du squelette dans le cadre d'un bilan de cancer.` },
      { label: 'Bilan cardiologique : coroscanner, score calcique', explication: `Le scanner cardiaque permet d'examiner les arteres du coeur sans intervention et d'evaluer la presence de depots de calcium, ce qui aide le cardiologue a estimer la sante des arteres coronaires.` },
      { label: 'Urgences : traumatismes, AVC, abdomen aigu', explication: `Grace a sa rapidite, le scanner est l'examen de choix en situation d'urgence : il fait rapidement le point apres un accident, devant des signes d'accident vasculaire cerebral ou une douleur abdominale brutale.` },
    ],
  },
  {
...
A la Clinique Pasteur de Tunis, la table telecommandee de derniere generation permet de realiser l'ensemble des examens de radiologie conventionnelle avec contraste dans des conditions optimales de qualite et de securite. L'equipe de radiologues experimentes adapte le protocole a chaque situation clinique pour un diagnostic precis.`,
    ...
    indications: [
      { label: 'Transit oeso-gastro-duodenal : reflux, ulcere, hernie hiatale, tumeur', explication: `Apres avoir bu un produit de contraste, le radiologue suit en direct son trajet dans l'oesophage et l'estomac. Cet examen aide a comprendre des brulures, des remontees acides ou une gene pour avaler.` },
      { label: 'Transit du grele : maladie de Crohn, occlusion, tumeur', explication: `Cet examen suit la progression du produit de contraste dans l'intestin grele, une zone difficile d'acces. Il est utile pour explorer des douleurs, une inflammation chronique ou un ralentissement du transit.` },
      { label: 'Lavement baryte : polypes, tumeur colique, diverticulose', explication: `Le produit de contraste introduit par voie rectale dessine les contours du gros intestin sur les images. Il permet de reperer des irregularites de la paroi du colon lorsque la coloscopie n'est pas realisable.` },
      { label: 'Cystographie : reflux vesico-ureteral, incontinence, tumeur vesicale', explication: `En remplissant la vessie de produit de contraste, le radiologue observe son fonctionnement pendant le remplissage et la vidange. Cet examen aide a comprendre des infections urinaires repetees ou des fuites urinaires.` },
      { label: 'Hysterosalpingographie : bilan d\'infertilite, permeabilite tubaire', explication: `Cet examen verifie que les trompes ne sont pas bouchees et que la cavite de l'uterus a une forme normale. Il fait partie du bilan propose aux couples qui rencontrent des difficultes a concevoir.` },
      { label: 'Arthrographie : lesions articulaires avant IRM ou en complement', explication: `Un produit de contraste injecte dans l'articulation rend visibles des structures fines comme le cartilage ou les ligaments. Cet examen complete parfois l'IRM pour mieux analyser une articulation douloureuse.` },
      { label: 'Exploration de la deglutition et des fistules digestives', explication: `En filmant le passage du produit de contraste en temps reel, le radiologue analyse la maniere dont le patient avale et recherche d'eventuels trajets anormaux dans le tube digestif, par exemple apres une chirurgie.` },
    ],
  },
  {
...
A la Clinique Pasteur de Tunis, les salles de radiologie sont equipees de tables capteur plan de derniere generation, garantissant des images de qualite optimale pour un diagnostic fiable. Le systeme numerique permet une transmission rapide des images et un archivage securise dans le dossier patient informatise.`,
    ...
    indications: [
      { label: 'Fractures et traumatismes osseux', explication: `Apres une chute ou un choc, la radiographie est le premier examen realise : elle montre immediatement si un os est casse, fissure ou deplace, et guide la suite de la prise en charge.` },
      { label: 'Arthrose et pathologies articulaires degeneratives', explication: `Quand une articulation devient douloureuse ou raide avec le temps, la radiographie permet d'evaluer l'usure du cartilage et les modifications des os, afin d'adapter le traitement.` },
      { label: 'Tumeurs osseuses primitives et metastases', explication: `Devant des douleurs osseuses inhabituelles ou dans le cadre d'un bilan de cancer, la radiographie recherche des zones anormales dans les os et oriente vers des examens complementaires si besoin.` },
      { label: 'Infections osseuses (osteomyelite, arthrite septique)', explication: `Lorsqu'une infection de l'os ou d'une articulation est suspectee, par exemple devant une douleur associee a de la fievre, la radiographie aide a en reperer les signes et a suivre l'evolution sous traitement.` },
      { label: 'Malformations osseuses et troubles de la croissance', explication: `Chez l'enfant comme chez l'adulte, la radiographie permet d'etudier la forme et l'alignement des os, par exemple pour surveiller une scoliose ou verifier le bon deroulement de la croissance.` },
      { label: 'Pathologies pulmonaires : pneumopathie, pneumothorax, tumeur, epanchement pleural', explication: `La radiographie du thorax est l'examen de base devant une toux qui traine, une fievre, un essoufflement ou une douleur thoracique : elle donne rapidement une vue d'ensemble des poumons et du coeur.` },
      { label: 'Bilan radiologique preoperatoire', explication: `Avant certaines interventions, le chirurgien demande des radiographies pour planifier son geste avec precision, par exemple pour choisir et positionner une prothese articulaire.` },
      { label: 'Surveillance post-operatoire de materiel d\'osteosynthese ou de protheses', explication: `Apres la pose de vis, de plaques ou d'une prothese, des radiographies regulieres verifient que le materiel reste bien en place et que l'os consolide correctement.` },
    ],
  },
  {
    slug: 'mammographie',
...
A la Clinique Pasteur de Tunis, la mammographie est realisee sur un mammographe numerique de derniere generation offrant une resolution d'image exceptionnelle avec une dose de radiation minimale. Les radiologues specialises en senologie assurent une lecture attentive et une prise en charge complete en cas d'anomalie detectee.`,
    ...
    indications: [
      { label: 'Depistage systematique du cancer du sein a partir de 40 ans (ou plus tot en cas de risque familial)', explication: `Meme sans aucun symptome, une mammographie reguliere permet de detecter d'eventuelles anomalies a un stade tres precoce, quand elles sont encore invisibles et impalpables, ce qui augmente considerablement les chances de guerison.` },
      { label: 'Exploration d\'une anomalie clinique : nodule palpable, ecoulement mamelonnaire, retraction cutanee', explication: `Si vous ou votre medecin avez remarque une boule, un ecoulement ou une modification de la peau du sein, la mammographie aide a en preciser la nature et a decider des examens complementaires eventuels.` },
      { label: 'Surveillance apres traitement d\'un cancer du sein', explication: `Apres un traitement, des mammographies regulieres verifient la bonne cicatrisation des tissus et permettent de detecter tres tot toute nouvelle anomalie, pour un suivi serein.` },
      { label: 'Bilan avant chirurgie esthetique mammaire', explication: `Avant une intervention esthetique du sein, une mammographie s'assure de l'absence d'anomalie sous-jacente, afin que la chirurgie se deroule dans les meilleures conditions de securite.` },
      { label: 'Douleur mammaire persistante et inexpliquee', explication: `Une douleur du sein qui dure est le plus souvent benigne, mais la mammographie permet d'en rechercher la cause et de rassurer la patiente en ecartant une anomalie du tissu mammaire.` },
      { label: 'Suivi de lesions mammaires classees probablement benignes (BI-RADS 3)', explication: `Certaines images consideres comme tres probablement benignes font l'objet d'une simple surveillance rapprochee : des controles reguliers verifient qu'elles restent stables au fil du temps.` },
      { label: 'Antecedents familiaux de cancer du sein (depistage renforce)', explication: `Quand des proches ont ete touchees par un cancer du sein, un suivi plus precoce et plus rapproche est propose afin de detecter au plus tot la moindre anomalie.` },
    ],
  },
  {
...
A la Clinique Pasteur de Tunis, l'appareil de panoramique dentaire numerique 2D fournit des images de haute resolution permettant un diagnostic precis. L'examen est rapide, confortable et delivre une dose de radiation tres faible, equivalente a environ une journee d'exposition naturelle au rayonnement ambiant.`,
    ...
    indications: [
      { label: 'Bilan dentaire complet : caries, infections, parodontite', explication: `En une seule image, le dentiste visualise l'ensemble des dents et de l'os qui les soutient. Cela permet de reperer des caries cachees, des infections a la racine des dents ou un dechaussement debutant.` },
      { label: 'Evaluation des dents de sagesse avant extraction', explication: `Avant de retirer des dents de sagesse, le panoramique montre leur position, l'orientation de leurs racines et leur proximite avec les nerfs, ce qui permet au praticien de planifier un geste sur et precis.` },
      { label: 'Bilan pre-implantaire et pre-orthodontique', explication: `Avant la pose d'implants ou un traitement d'orthodontie, cette vue d'ensemble permet d'evaluer la quantite d'os disponible et la position de toutes les dents pour bien preparer le traitement.` },
      { label: 'Recherche de dents incluses ou surnumeraires', explication: `Certaines dents restent bloquees dans l'os ou se developpent en surnombre sans etre visibles en bouche. Le panoramique les localise precisement, notamment chez l'enfant et l'adolescent.` },
      { label: 'Traumatismes de la face et de la mandibule', explication: `Apres un choc au visage, cet examen rapide verifie l'integrite de la machoire et des dents, et permet de reperer une eventuelle fracture.` },
      { label: 'Kystes et tumeurs des maxillaires', explication: `Le panoramique permet de deceler des lesions developpees dans l'os des machoires, souvent silencieuses, et d'orienter si necessaire vers une imagerie plus detaillee.` },
      { label: 'Pathologies des articulations temporo-mandibulaires', explication: `En cas de douleurs a la machoire, de craquements ou de difficultes a ouvrir la bouche, cet examen donne un premier apercu des articulations qui relient la machoire au crane.` },
      { label: 'Bilan de sinusite maxillaire d\'origine dentaire', explication: `Certaines sinusites proviennent d'une dent infectee dont la racine est proche du sinus. Le panoramique aide a identifier la dent en cause afin de traiter le probleme a sa source.` },
    ],
  },
  {
...
A la Clinique Pasteur de Tunis, l'osteodensitometrie est realisee sur un appareil DEXA de derniere generation, offrant une precision de mesure optimale avec une dose de radiation infime. Le radiologue interprete les resultats en tenant compte de l'ensemble du contexte clinique et des facteurs de risque du patient.`,
    ...
    indications: [
      { label: 'Depistage de l\'osteoporose chez la femme menopausee', explication: `Apres la menopause, les os peuvent se fragiliser sans aucun symptome. Cette mesure simple et indolore permet de savoir si les os restent solides et, si besoin, de commencer un traitement avant toute fracture.` },
      { label: 'Traitement prolonge par corticoides (corticotherapie superieure a 3 mois)', explication: `Les traitements prolonges par cortisone peuvent fragiliser les os. L'osteodensitometrie surveille leur solidite et permet au medecin de proposer une protection osseuse si necessaire.` },
      { label: 'Antecedent de fracture de fragilite (vertebre, poignet, col du femur)', explication: `Une fracture survenue apres une simple chute de sa hauteur peut reveler une fragilite des os. L'examen le confirme et guide la mise en place d'un traitement pour eviter d'autres fractures.` },
      { label: 'Hypogonadisme, menopause precoce ou amenorrhee prolongee', explication: `Les hormones jouent un role protecteur essentiel pour les os. Lorsque leur production diminue tot ou de facon prolongee, il est utile de verifier la densite osseuse.` },
      { label: 'Hyperparathyroidie primaire et autres endocrinopathies', explication: `Certaines maladies des glandes hormonales accelerent la perte osseuse. La mesure de la densite osseuse fait partie du bilan et du suivi de ces affections.` },
      { label: 'Suivi de traitement anti-osteoporotique (controle a 2-3 ans)', explication: `Quand un traitement contre l'osteoporose est en cours, un controle regulier de la densite osseuse permet de verifier qu'il est efficace et de l'ajuster si besoin.` },
      { label: 'Maladies inflammatoires chroniques (polyarthrite rhumatoide, maladie de Crohn)', explication: `Les maladies inflammatoires au long cours, et parfois leurs traitements, peuvent retentir sur la solidite des os. Une surveillance reguliere aide a prevenir les complications osseuses.` },
      { label: 'Antecedents familiaux de fracture du col femoral', explication: `La fragilite osseuse comporte une part hereditaire. Si un parent proche a subi une fracture de la hanche, un depistage permet d'evaluer votre propre risque et d'agir en prevention.` },
    ],
  },
  {
    slug: 'echographie',
...
A la Clinique Pasteur de Tunis, les echographies sont realisees sur des appareils de derniere generation offrant une resolution d'image exceptionnelle. Les radiologues specialises adaptent le type de sonde et le protocole a chaque indication, garantissant un examen complet et un diagnostic precis.`,
    ...
    indications: [
      { label: 'Douleurs abdominales : exploration du foie, de la vesicule biliaire, du pancreas, des reins', explication: `Devant un mal de ventre, l'echographie est souvent le premier examen demande : elle visualise sans douleur les principaux organes de l'abdomen et recherche par exemple des calculs de la vesicule ou une anomalie du foie ou des reins.` },
      { label: 'Pathologies thyroidiennes : nodules, goitre, thyroidite', explication: `Si la glande thyroide semble augmentee de volume ou si une petite boule est palpee au niveau du cou, l'echographie en precise la taille et l'aspect et aide a decider de la conduite a tenir.` },
      { label: 'Pathologies mammaires : complement de la mammographie, guidage de biopsie', explication: `L'echographie complete la mammographie, en particulier chez les femmes aux seins denses. Elle aide a distinguer un kyste rempli de liquide d'un nodule solide et guide un eventuel prelevement.` },
      { label: 'Suivi de grossesse : echographies du 1er, 2eme et 3eme trimestre', explication: `Tout au long de la grossesse, l'echographie suit la croissance et le bien-etre du bebe en toute securite, sans aucune radiation, pour la maman comme pour l'enfant.` },
      { label: 'Pathologies pelviennes : fibromes uterins, kystes ovariens, pathologie prostatique', explication: `Pour explorer des douleurs du bas-ventre, des regles anormalement abondantes ou des troubles urinaires, l'echographie examine l'uterus, les ovaires ou la prostate de facon simple et indolore.` },
      { label: 'Pathologies vasculaires : thrombose veineuse, stenose carotidienne, anevrisme aortique', explication: `Grace au mode Doppler, l'echographie observe le sang circuler dans les vaisseaux : elle recherche un caillot dans une jambe gonflee, verifie les arteres du cou ou surveille le diametre de l'aorte.` },
      { label: 'Pathologies musculo-tendineuses : tendinopathies, dechirures musculaires, epanchements articulaires', explication: `Apres un effort ou un accident sportif, l'echographie examine muscles et tendons en mouvement, ce qui permet de confirmer une dechirure ou une inflammation et d'adapter la reprise d'activite.` },
      { label: 'Guidage de gestes interventionnels : ponctions, biopsies, infiltrations', explication: `En visualisant l'aiguille en temps reel, l'echographie permet au medecin de realiser des prelevements ou des injections avec une grande precision et un maximum de securite.` },
    ],
  },
  {
...
A la Clinique Pasteur de Tunis, les procedures de radiologie interventionnelle sont realisees par des radiologues interventionnels experimentes, dans un environnement sterile et securise. Les equipements d'imagerie de derniere generation permettent un guidage precis des gestes, garantissant l'efficacite du traitement et la securite du patient.`,
    ...
    indications: [
      { label: 'Embolisation de fibromes uterins symptomatiques', explication: `Quand des fibromes provoquent des saignements abondants ou des douleurs, cette technique permet de les assecher en bloquant leur alimentation en sang, sans operation et en preservant l'uterus.` },
      { label: 'Embolisation d\'hemorragies actives (post-partum, digestive, traumatique)', explication: `En cas de saignement important, le radiologue peut obstruer de l'interieur le vaisseau qui saigne, a l'aide d'un fin catheter. Ce geste rapide permet souvent d'arreter l'hemorragie sans chirurgie ouverte.` },
      { label: 'Chimio-embolisation des tumeurs hepatiques (carcinome hepatocellulaire)', explication: `Ce traitement delivre un medicament directement dans la tumeur du foie tout en bloquant les vaisseaux qui la nourrissent, ce qui concentre l'effet sur la lesion en epargnant le reste de l'organe.` },
      { label: 'Thermoablation par radiofrequence des tumeurs du foie, du rein et du poumon', explication: `Une fine aiguille placee au coeur de la tumeur sous controle de l'imagerie la detruit par la chaleur. Cette option est precieuse pour les patients chez qui une chirurgie n'est pas souhaitable.` },
      { label: 'Drainage d\'abces abdominaux, pelviens ou thoraciques', explication: `Plutot que d'operer, le radiologue peut evacuer une poche d'infection en placant un petit drain a travers la peau, guide par l'imagerie. Le patient est ainsi soulage avec un geste peu invasif.` },
      { label: 'Embolisation de malformations vasculaires et d\'aneurysmes visceraux', explication: `Certaines anomalies des vaisseaux presentent un risque de saignement. L'embolisation permet de les fermer de l'interieur, par les voies naturelles du reseau sanguin, et d'ecarter ce risque.` },
      { label: 'Vertebroplastie et cimentoplastie pour les fractures vertebrales osteoporotiques', explication: `L'injection d'un ciment medical dans une vertebre fracturee et douloureuse la consolide rapidement. Ce geste soulage la douleur et permet de retrouver plus vite la mobilite.` },
      { label: 'Pose de drains biliaires et nephrostomies percutanees', explication: `Lorsque la bile ou les urines ne peuvent plus s'ecouler normalement, un drain place a travers la peau retablit leur evacuation, soulage le patient et protege l'organe concerne.` },
    ],
  },
];
